...
public interface PostMapper {
	...
	public void leaveComment(@Param("pId") String pId, @Param("user_id") String user_id,
	...
	public void uppdatePost(@Param("pId") String pId, @Param("userId") String userId,
			@Param("pcontents") String pcontents);
