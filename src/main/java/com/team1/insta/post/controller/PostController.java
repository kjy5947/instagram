...
public class PostController {
	...
	public String getPersonalPage(HttpServletRequest request, HttpServletResponse response, Model model,
		...
		if (mySid.equals("")) {
			...
			followState = userMapper.getFollowInfo(unameUser.getUser_id(),
					userMapper.getUserByUsername(userName).getUser_id());
	...
	public String getString(HttpServletRequest request, MultipartHttpServletRequest multireq,
			RedirectAttributes redirectAttribute, Model model, @PathVariable String userName,
	...
	public String getFollow(HttpServletRequest request, HttpServletResponse response, @RequestParam String button,
			@PathVariable String userName) {
